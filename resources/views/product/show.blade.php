...
<main>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5  text-white overflow-hidden " >
      <div class="my-3 py-3 ">
        ...
        <img src="https://www.barcouniforms.com/wp-content/uploads/2021/02/Garment-Image-5-bottles.gif" width="80%" alt="{{ $product->name }}">
    ...
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      ...
      <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 150px; border-radius: 21px 21px 0 0;">
        <img src="https://www.majas-lapu-izstrade.lv/wp-content/uploads/2018/11/woocommerce-all-product-review-average-rating.gif" width="100%" alt="{{ $product->name }}">
      </div>
    </div>
  </div>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5" style="color:red">€ {{ $product->price }}</h2>
        <p class="lead">Tax VAT not included</p>
        <div>
          <label for="quantity">Quantity :</label>
          <input type="number" name="quantity" class="" min="1" max="{{ $product->quantity }}">
          <span>  ( Max: {{ $product->quantity }} pieces )</span>
        </div>
      </div>
      <div class="bg-dark shadow-sm mx-auto d-flex align-items-center justify-content-center text-white " style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
        <a href="#">
          <img src="https://cdn.dribbble.com/users/146773/screenshots/4228811/dribble_cart.gif" alt="{{ $product->name }}">
        </a>
      </div>
    </div>
    <div class="bg-primary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
      <div class="my-3 py-3">
        <img src="https://i.shgcdn.com/f0178b5f-1622-4f83-a2c5-93e0cf511518/-/format/auto/-/preview/3000x3000/-/quality/lighter/" width="80%" alt="{{ $product->name }}">
      </div>
    </div>
  </div>
