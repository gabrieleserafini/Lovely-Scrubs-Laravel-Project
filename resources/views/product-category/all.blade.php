        ...
        @foreach($categories as $category)
            ...
            <div class="row featurette">
                <div class="col-md-7 order-md-2">
                    <h2 class="featurette-heading">{{ $category->name }} <small class="text-muted">See the real quality.</small></h2>
                    <a class="btn btn-lg btn-outline-primary" href="/product-categories/{{ $category->id }}/products"> Show Category &raquo;</a>
